Judge whether this document is relevant to the electric power utility stakeholders — the generation, transmission, distribution, operation, planning, reliability, resilience, regulation, workforce, or community service of electricity, including how the power system copes with weather, climate, and other hazards.
...
* Risk: the likelihood and/or magnitude of harm to the power system, its customers, or the electricity service it provides. Pure financial risk, medical risk, or unrelated engineering reliability not tied to electricity service or electric power utilities does not qualify.

THE CORE TEST — apply this first, before anything else. A document is RELEVANT only if it is true that:

* POWER SECTOR: the document substantively involves the electric power sector or electric power utilities (see topics below), AND it does so as a real focus of the work — not merely as an example, application, or passing mention.
...
* Generation and power supply: power plants and stations, coal/gas/diesel/fuel oil, nuclear, hydropower, solar PV, wind, geothermal, grid-scale battery and energy storage, distributed energy resources, cooling water and the water-energy nexus
* Reliability and operations: power outages, service interruption and restoration, reliability indices (SAIDI, SAIFI, CAIDI), blackouts, load shedding, cascading failures, grid operations, dispatch, reserve margins, frequency stability, voltage stability, phase stability, storm response, line/conductor galloping, line/conductor sag
* Planning and markets: integrated resource planning, capacity expansion, transmission/distribution planning, load and demand forecasting, peak demand, capacity and energy markets, interconnection queue, grid integration of renewables, wildfire mitigation plans, resilience planning, capital planning
* Assets and maintenance: asset management, aging infrastructure, equipment failure, preventive maintenance, predictive maintenance, corrective maintenance, vegetation management, right-of-way, public safety power shutoffs (PSPS), physical damage (downed wires, pole failure, ice loading, flood/wind damage)
...
* Regulation and policy: public utility commissions, rate cases and design, reliability and resilience standards (NERC, North American Electric Reliability Corporation, NESC, National Electrical Safety Code), FERC, Federal Energy Regulatory Commission, renewable portfolio standards, utility investment and cost recovery
* Resilience and climate risk: power-system and grid resilience, climate adaptation and risk for utilities, extreme-weather impacts on the grid, grid hardening and design standards, disaster preparedness and recovery for utilities, vulnerability analysis
* Equity, workforce, and institutions: energy burden/poverty/justice as it affects electricity customers, community resilience and critical loads, the utility workforce (lineworkers, occupational/heat safety), and sector institutions (DOE, Department of Energy, EPRI, Electric Power Research Institute, FEMA programs for grid/infrastructure)
...
* score 1 -> decision "maybe": Partial or indirect. The power sector appears but is underdeveloped, OR the document is about energy in general with only a weak link to the electric power subsector or electric utilities. Potentially useful but unclear.
...
Common false positives to mark IRRELEVANT unless they explicitly center on the electricity subsector or electric power utilities:
...
* General energy, sustainability, or climate papers with no clear connection to electric power utilities, the grid, or power generation/delivery.
...
* Positive descriptive test: ask "does this document describe something about how electricity is generated, transmitted, distributed, delivered, planned for, operated, regulated, or kept reliable and resilient?"
