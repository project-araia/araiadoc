...
NORMALIZE_CASES = [
    ...
    ("I. INTRODUCTION", "introduction", "Roman prefix I"),
    ...
    ("1.Introduction", "introduction", "Digit prefix no space"),
    ...
    ("III. RESULTS", "results", "Results roman prefix III"),
    ("IV. RESULTS", "results", "Results roman prefix IV"),
    ("V. RESULTS", "results", "Results roman prefix V"),
    ("II. RESULTS", "results", "Results roman prefix II"),
    ...
    ("V. CONCLUSION", "conclusion", "Conclusion roman prefix V"),
    ("IV. CONCLUSION", "conclusion", "Conclusion roman prefix IV"),
    ("VI. CONCLUSION", "conclusion", "Conclusion roman prefix VI"),
    ...
    ("III. RESULTS AND DISCUSSION", "results and discussion", "R&D roman prefix III"),
    ("IV. RESULTS AND DISCUSSION", "results and discussion", "R&D roman prefix IV"),
    (
    ...
    ("3.2.1 Discussion", "discussion", "Multi-level digit prefix"),
    ("(2) Background", "background", "Parenthesized digit prefix"),
    ("[III] Results", "results", "Bracketed roman prefix"),
